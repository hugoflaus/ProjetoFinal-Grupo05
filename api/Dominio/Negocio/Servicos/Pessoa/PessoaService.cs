...
namespace api.Dominio.Negocio.Servicos.Usuarios
{
    public class PessoaService 
    {
        ...
        {
            var pessoa = await entityRepositorio.BuscarPorId<Pessoa>(pessoa => pessoa.Id == id);
            if (pessoa == null)
                throw new Exception("Usuario não encontrado.");
        ...
        {
            var pessoaAlteracao = await entityRepositorio.BuscarPorId<Pessoa>(pessoa => pessoa.Id == id);
